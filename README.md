...
## 🧑‍💻 Tecnologias
- <a Dados serão coletados a partir de sensores: ESP32

- <a Dados serão armazenados em um banco de dados local

- <a Integração com modelos de IA: TensorFlow

-<a Processamento acontecerá em um computador local
